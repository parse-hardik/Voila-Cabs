...
public class Change_Name extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter New Full Name");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            stmt.executeUpdate("update login set name = \"" +newName+ "\" where username = \"" +username+ "\" ;");
            JOptionPane.showMessageDialog(this,"Name updated in the database!");
            conn.close();
        }
        catch(Exception e)
        {
